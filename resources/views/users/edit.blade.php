            ...
            <section class="col-lg-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('dashboardusers.update', $user->id) }}" method="post" enctype="multipart/form-data">
                            @csrf @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                @if ($user->profile_photo_path)
                                    <img src="{{ asset('/storage/assets/profile/' . $user->profile_photo_path) }}" alt="" height="100">
                                @endif
                            </div>
